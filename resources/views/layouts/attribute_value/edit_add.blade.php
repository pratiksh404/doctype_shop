<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <select class="form-control select2" style="width: 100%;" name="input_type">
            <option value="1" {{isset($attribute) ? $attribute->input_type == "Drop Down" ? 'selected' : '' : ''}}>Drop
                Down</option>
            <option value="2" {{isset($attribute) ? $attribute->input_type == "Radio" ? 'selected' : '' : ''}}>Radio
            </option>
            <option value="3" {{isset($attribute) ? $attribute->input_type == "Text" ? 'selected' : '' : ''}}>Text
            </option>
            <option value="4" {{isset($attribute) ? $attribute->input_type == "Text Area" ? 'selected' : '' : ''}}>Text
                Area</option>
        </select>
    </div>
</div>
